    ...
    <el-row justify="start" align="top">
      <el-col>
        <el-form-item label="是否同意" prop="agree">
          <el-switch v-model="nodeContentCpt.agree" />
        </el-form-item>
      </el-col>
      <el-col>
        <el-form-item label="备注" prop="remark" >
          <el-input type="textarea" v-model="nodeContentCpt.remark" :autosize="{ minRows: 2, maxRows: 8 }"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
...
import {getJwsPayload} from '@kaseihaku.com/core-com';
...
const rules = {
  agree: [
    { type: 'boolean', required: true, message: '是否同意 必填'},
  ],
};
